...
def create_parser():
    ...
    parser.add_argument("--learning_strategies", type=str, nargs="+", help="Type of learning strategy. Options: random topn2bottomn2 topn dist")
    ...
    parser.add_argument("--first_round_strategies", type=str, nargs="+", help="Type of first round strategy. Options: random diverse_medoids representative_hie explicit_variants")
    ...
    parser.add_argument("--explicit_variants", type=str, nargs="+",
                        help="List of explicit variants for first_round_strategies=explicit_variants")
...
def main():
    ...
    grid_search(
        ...
        explicit_variants=args.explicit_variants
    )
